...
| Select a feasible repository contribution | KeeperHub issue #2105 verified against current `staging`; accepted/confirmed; no competing PR found on Sep 2 | Provisionally proven | Recheck issue, comments, branch, and PR search when the build window opens. |
