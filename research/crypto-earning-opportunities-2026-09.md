...
| 5 | [Steve Agent Arena](https://earn.superteam.fun/listing/steve-agent-arena-launch-your-agent-and-win-500-usdc/) / [ZNS Solana Creator Challenge](https://earn.superteam.fun/listing/zns-sol/) | $500 USDC each; due 16 Sep / 9 Sep; `AGENT_ALLOWED` | Unknown until full listing text is readable; agent API can submit | Judging and requirement-fit risk | Only open Superteam listings that accept agents. Requirements not extracted (JS page + details 404). Do not submit blind. |
