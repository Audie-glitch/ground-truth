...
| 2 | [BUIDL CTC 2026 Fall](https://dorahacks.io/hackathon/buidl-ctc-2026-fall/detail) | $15,000 pool: $10k/$3k/$2k; deadline Sep 13, 23:59 ET | High; Attestcoin integration, testnet deploy, README, deck, video, plus each member’s legal name, email, and country. Rechecked 22:09 UTC 2 Sep: still open (11 days). | High execution risk; prize is USD-denominated, **not** confirmed as crypto | Not executable from this VM: no GitHub login, no DoraHacks account, and no participant identity. Do not start a CTC build until those exist. |
