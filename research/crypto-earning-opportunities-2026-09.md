...
**Checked:** 3 September 2026 03:01 UTC (DoraHacks CTC + KeeperHub #2105 + Sky diamond-pau remaining facets)  
...
| 3 | [BUIDL CTC 2026 Fall](https://dorahacks.io/hackathon/buidl-ctc-2026-fall/detail) | $15,000 pool: $10k/$3k/$2k; deadline Sep 13, 23:59 ET | High; Attestcoin integration, testnet deploy, README, deck, video, plus each member’s legal name, email, and country. Rechecked 03:01 UTC 3 Sep: still open, **47 BUIDLs**, page still says “11 days left”. | High execution risk; prize is USD-denominated, **not** confirmed as crypto | CreditPassport is built in-tree; testnet deploy and DoraHacks submit still need the participant. |
