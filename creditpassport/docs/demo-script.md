...
| 2:45 | Any address | `npm run cli -- import 0x…` on an active Sepolia USDC sender: real transfers found, batch-proved, recorded, underwritten in one command. Caption: `# Real USDC history, proven, becomes a passport.` |
